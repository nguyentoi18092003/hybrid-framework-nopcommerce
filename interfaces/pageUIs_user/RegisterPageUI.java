...
public class RegisterPageUI {
    ...
    public static final String PASSWORD_ERROR_MSG="//span[@id='ConfirmPassword-error']";
    public static final String PASSWORD_ERROR_MSG_2="//span[@class='field-validation-error']";
